About strip-hints-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/strip-hints-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9168&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/strip-hints-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `strip-hints` can be installed with `conda`:
...
```
mamba install strip-hints
```

It is possible to list all of the versions of `strip-hints` available on your platform with `conda`:
...
```
mamba search strip-hints --channel conda-forge
```
...
mamba repoquery search strip-hints --channel conda-forge

# List packages depending on `strip-hints`:
mamba repoquery whoneeds strip-hints --channel conda-forge

# List dependencies of `strip-hints`:
mamba repoquery depends strip-hints --channel conda-forge
```
